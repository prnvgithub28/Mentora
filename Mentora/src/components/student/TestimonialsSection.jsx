...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl font-medium text-gray-800'>Insights</h2>
      <p className='md:text-base text-gray-500 mt-3'>Discover inspiring stories from our learners as they talk about their growth, achievements,
        <br/>and the impact our platform has had on their lives.</p>
